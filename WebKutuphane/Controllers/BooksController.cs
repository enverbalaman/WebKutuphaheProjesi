...
namespace WebKutuphane.Controllers
{
    public class BooksController : Controller
    {
        ...
        {
            var departmentsQuery = from d in _context.Genres
                                   orderby d.Name
                                   select d;
            ViewBag.Id = new SelectList(departmentsQuery.AsNoTracking(), "Id", "Name", selectedDepartment);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind ("Id,Title,GenresId,Author")] Books books)
        {
